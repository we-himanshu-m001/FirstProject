...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-firstproject';
        ...
        */
        ...
        return view('firstproject::backend.pages.app');
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            'name' => config('firstproject.name'),
            'version' => config('settings.global.firstproject_version')??config('firstproject.version'),
            'is_dev' => config('firstproject.is_dev'),
        ];
